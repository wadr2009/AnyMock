...
CREATE TABLE `anymock_http_interface`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL comment '描叙',
  `need_async_callback` tinyint(1) NOT NULL comment '是否需要异步回调',
  ...
  `sync_script` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL comment '同步脚本',
  `async_script` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL comment '异步脚本',
  `sync_delay` int(11) NOT NULL comment '同步延迟',
  `async_delay` int(11) NOT NULL comment '异步延迟',
...
) ENGINE = InnoDB AUTO_INCREMENT = 98 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact comment 'anymockhttp接口';
